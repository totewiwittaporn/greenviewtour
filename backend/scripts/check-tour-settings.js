...
try{
 ...
 await prisma.$transaction(async tx=>{
  ...
  const partner=await create('partners',{code:`${prefix}-A`,name:'Rollback Partner A',roles:['SALES_AGENT','TOUR_OPERATOR','TRANSPORT_PROVIDER']})
  ...
  await create('locations',{code:`${prefix}-H`,name:'Rollback hotel',latitude:'7.88',longitude:'98.39'})
