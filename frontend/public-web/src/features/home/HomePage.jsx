...
export default function HomePage() {
  ...
  return <main id="content" className="home-page">
    ...
    <CompanyLocation/>
    <section className="home-surin" id="surin" aria-labelledby="surin-title"><div className="home-container home-surin-layout"><img src="/images/home/surin-story.webp" alt={t('บรรยากาศธรรมชาติจาก Greenview Tour')} loading="lazy" width="1200" height="900"/><div><p className="section-eyebrow">{t('MORE THAN A DAY AT SEA')}</p><h2 id="surin-title">{t('รู้จักหมู่เกาะสุรินทร์')}</h2><p>{t('สัมผัสวิถีชีวิตหมู่บ้านมอแกน เดินเล่นริมชายหาด และลงไปพบสีสันของแนวปะการัง ให้การเดินทางครั้งนี้เป็นเวลาของคุณ')}</p><div className="home-surin-topics"><span>{t('โลกใต้ทะเล')}</span><span>{t('ชายหาดและธรรมชาติ')}</span><span>{t('วิถีชีวิตมอแกน')}</span></div><a className="home-text-link" href="/tours">{t('ดูโปรแกรมทั้งหมด')} <span aria-hidden="true">→</span></a></div></div></section>
