...
export function SiteHeader(){
  ...
  return <>
    <div className="public-topbar">
      ...
      <div className="public-topbar-actions"><LanguageSelector/><a className="customer-login" href={customerLogin}>Login / Register</a></div>
    </div>
    <header className="site-header" ref={container}>
      ...
      <button ref={trigger} type="button" className="public-menu-toggle" aria-expanded={open} aria-controls={id} aria-label={locale==='th'?'เมนูหลัก / Main menu':'Main menu'} onClick={()=>setOpen(!open)}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true"><path d={open?'M6 6l12 12M18 6L6 18':'M4 6h16M4 12h16M4 18h16'}/></svg></button>
