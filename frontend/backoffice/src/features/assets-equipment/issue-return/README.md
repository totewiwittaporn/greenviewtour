...
Backend counterpart: `backend/src/backoffice/assets-equipment/issue-return`.

See `docs/backoffice-menu-map.md` for ownership and `docs/identity-access.md` for the initial access plan. Folder/menu visibility does not grant permission.
