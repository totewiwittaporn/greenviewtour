...
try {
  ...
  const triggerBox = await roleTrigger.boundingBox(), popupBox = await rolePopup.boundingBox()
  ...
  await page.screenshot({ path: fileURLToPath(new URL('compact-select-desktop.png', output)), fullPage: true })
  await page.keyboard.press('Escape')
  ...
  await page.getByRole('button', { name: '+ Add employee', exact: true }).click()
  await page.getByRole('combobox', { name: 'Department', exact: true }).click()
  const mobileTrigger = await page.getByRole('combobox', { name: 'Department', exact: true }).boundingBox()
  ...
  await page.screenshot({ path: fileURLToPath(new URL('compact-select-mobile.png', output)), fullPage: true })
  await page.keyboard.press('Escape')
  await page.getByRole('button', { name: 'Close dialog' }).click()
