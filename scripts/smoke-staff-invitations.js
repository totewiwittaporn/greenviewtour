...
try {
  ...
  const firstMenuItem = page.getByRole('menuitem', { name: 'Edit profile', exact: true })
  ...
  assert.equal(await page.getByRole('menuitem', { name: 'Edit profile' }).evaluate(el => el === document.activeElement), true)
