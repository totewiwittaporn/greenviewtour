...
try {
  ...
  await page.route('**/api/me', route => route.fulfill({ json: { user: { id: 'fixture', displayName: 'Fixture user', permissions: ['users.read:COMPANY'], management: {company:true}, roles: [] } } }))
